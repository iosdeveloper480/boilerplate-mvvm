...
//-----------------------------------------------------------------------------------------------------------------------------------------------
public extension WALoader {
    
    class var animationType: WAAnimationType {
...
public extension WALoader {
    ...
    // MARK: -
    //-------------------------------------------------------------------------------------------------------------------------------------------
    class func show(_ status: String? = nil, icon: WAAlertIcon, interaction: Bool = true) {
    ...
    //-------------------------------------------------------------------------------------------------------------------------------------------
    class func show(_ status: String? = nil, icon animatedIcon: WAAnimatedIcon, interaction: Bool = true) {
...
public class WALoader: UIView {
    ...
    private var animationType    = WAAnimationType.systemActivityIndicator
    ...
    //-------------------------------------------------------------------------------------------------------------------------------------------
    static let shared: WALoader = {
        let instance = WALoader()
        return instance
    } ()
    ...
    // MARK: -
    //-------------------------------------------------------------------------------------------------------------------------------------------
    private func setup(status: String? = nil, progress: CGFloat? = nil, animatedIcon: WAAnimatedIcon? = nil, staticImage: UIImage? = nil, hide: Bool, interaction: Bool) {
...
//        setupToolbar()
        ...
        animationView!.frame = CGRect(origin: viewBackground!.center, size: CGSize(width: 80, height: 80))//viewBackground!.bounds
        animationView!.center = viewBackground!.center
    ...
    //-------------------------------------------------------------------------------------------------------------------------------------------
    private func setupAnimatedIcon(_ animatedIcon: WAAnimatedIcon?) {
